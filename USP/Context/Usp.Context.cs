...
namespace USP.Context
{
    ...
    public partial class USPEntities : DbContext
    {
        ...
        public virtual ObjectResult<Nullable<long>> UP_AddOperator(Nullable<long> corp, string loginName, string realName, string password, string idCard, string email, string mobile, Nullable<long> creator, string role)
        {
            var corpParameter = corp.HasValue ?
                new ObjectParameter("Corp", corp) :
                new ObjectParameter("Corp", typeof(long));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<long>>("UP_AddOperator", corpParameter, loginNameParameter, realNameParameter, passwordParameter, idCardParameter, emailParameter, mobileParameter, creatorParameter, roleParameter);
        }
