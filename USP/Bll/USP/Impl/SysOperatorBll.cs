...
namespace USP.Bll.Impl
{
    public class SysOperatorBll : ISysOperatorBll
    {
        ...
        {
            return operatorDal.SaveOperator(operators.Corp, operators.LoginName.Trim(), operators.RealName.Trim(), operators.Password.Trim(), operators.Mobile, operators.IdCard, operators.Email, operators.Creator, operators.Role);
        }
